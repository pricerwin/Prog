...
public class PizzaOrder
{
   public static void main (String[] args)
   {
      ...
      System.out.println("<><>"+discount); //checking to see discount comes out as true
      ...
      if(inches==10){
         ...
         System.out.println("You entered an invalid size, so a 12 inch pizza will be made.");
         cost=12.99;
      }
      ...
      if(discount==true){
         System.out.println("$2 discount will applied to your order!");
         cost-=2.00;
      }
